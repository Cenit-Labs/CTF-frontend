  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center px-4">
        ...
        <div className="relative bg-zinc-900 rounded-2xl p-4 sm:p-6 w-full max-w-[720px] max-h-[90vh] overflow-y-auto border border-zinc-800 z-10">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  ...
                  <div className="flex items-center gap-4">
                    <div className="w-20 h-20 sm:w-24 sm:h-24 rounded-full overflow-hidden border border-zinc-800 bg-zinc-800 flex-shrink-0">
                      <img
                    ...
                    <div className="flex flex-col gap-2">
                      <button
                        ...
                        className="bg-zinc-800 text-white px-3 py-2 rounded text-sm"
                      >
                        Upload
                      </button>
                      <input
                        ...
                        className="hidden"
                      />
                      <p className="text-zinc-500 text-xs sm:text-sm">PNG, JPG up to 2MB</p>
                    </div>
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full bg-black/20 border border-zinc-800 rounded px-3 py-2 text-white text-sm sm:text-base"
                    />
                  </div>

                  <div>
                    <label className="block text-sm text-zinc-400 mb-2">College</label>
                    <select
                  ...
                  <div>
                    ...
                    <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2">
                      <input
                        ...
                        disabled
                        className="flex-1 bg-black/20 border border-zinc-800 rounded px-3 py-2 text-zinc-500 text-sm sm:text-base"
                      />
                      {emailVerified ? (
                        <span className="px-3 py-2 rounded bg-green-500/20 text-green-400 text-sm border border-green-500/30 text-center">
                          Verified
                        </span>
                      ) : (
                        <button
                  ...
                  <div>
                    <label className="block text-sm text-zinc-400 mb-2">Discord Account</label>
                    {discordConnected ? (
                      ...
                      <button
                        ...
                        className="w-full flex items-center justify-center gap-2 bg-[#5865F2] text-white px-3 py-2 rounded font-semibold text-sm"
                      >
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                ...
                <button
                  ...
                  className="px-3 py-2 rounded bg-orange-500 text-black font-semibold cursor-pointer text-sm"
                >
                  Change password
                </button>
              </div>
          ...
          <div className="flex flex-col-reverse sm:flex-row justify-between items-stretch sm:items-center mt-6 gap-3">
            ...
            <div className="flex gap-3">
              <button
                ...
                className="flex-1 sm:flex-none px-4 py-2 rounded bg-transparent border border-zinc-700 text-zinc-300 text-sm sm:text-base"
              >
                Cancel
              </button>
              <button
                onClick={handleSave}
                className="flex-1 sm:flex-none px-4 py-2 rounded bg-orange-500 text-black font-semibold text-sm sm:text-base"
              >
                Save
              </button>
            </div>
      ...
      {showPasswordModal && (
        <div className="fixed inset-0 z-[60] flex items-center justify-center px-4">
          ...
          <div className="relative bg-zinc-900 rounded-2xl p-4 sm:p-6 w-full max-w-[480px] border border-zinc-800 z-10">
            <h3 className="text-xl sm:text-2xl font-bold mb-2">Setup Password</h3>
            ...
            <div className="flex gap-3 mt-6">
              <button
                onClick={() => setShowPasswordModal(false)}
                className="flex-1 px-4 py-2 rounded bg-transparent border border-zinc-700 text-zinc-300 text-sm sm:text-base"
              >
                Cancel
              </button>
              <button
                ...
                className="flex-1 px-4 py-2 rounded bg-orange-500 text-black font-semibold cursor-pointer text-sm sm:text-base"
              >
                Reset Password
              </button>
            </div>
