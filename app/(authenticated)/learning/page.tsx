          ...
          {courses.map((course, index) => (
            ...
            >
              ...
              <div className="mb-4">
                ...
                <div className="text-right text-sm text-gray-400 mt-1">{course.progress}%</div>
              </div>

              <button 
                className={`w-full py-3 rounded-lg font-semibold transition-all ${course.buttonStyle}`}
              >
                {course.buttonText}
              </button>
            </div>
